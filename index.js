...
const UUID = process.env.UUID || 'b664a75d-b5b4-402d-8df9-ce3c2e3ac8eb'; //若需要改UUID，需要在config.json里一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'huggingface.future13800.eu.org';                       // 仅能使用token，argo端口8080，cf后台设置需对应
